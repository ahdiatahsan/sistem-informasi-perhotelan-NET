...
{
    public partial class f_input_edit_karyawan
    {
        public f_input_edit_karyawan()
        {
            InitializeComponent();
            _Panel1.Name = "Panel1";
        ...
        public void simpan()
        {
            ...
            try
            {
                string sql = "insert into tb_karyawan values( NULL, " + "'" + T_nama.Text + "', " + "'" + C_jk.Text + "', " + "'" + T_alamat.Text + "', " + "'" + T_telp.Text + "')";
                cmd = new OdbcCommand(sql, conn);
                cmd.ExecuteNonQuery();
                reset();
                My.MyProject.Forms.f_karyawan.tampil_karyawan();
                Close();
        ...
        public void simpanUpdate()
        {
            ...
            try
            {
                string sql = "update tb_karyawan set" + " nama_karyawan='" + T_nama.Text + "', " + " jenis_kelamin='" + C_jk.Text + "', " + " alamat='" + T_alamat.Text + "', " + " no_telp='" + T_telp.Text + "'" + " where id='" + L_id.Text + "'";
                cmd = new OdbcCommand(sql, conn);
                cmd.ExecuteNonQuery();
                reset();
                My.MyProject.Forms.f_karyawan.tampil_karyawan();
        ...
        public void ketemu()
        {
            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    T_nama.Text = Conversions.ToString(dr["nama_karyawan"]);
