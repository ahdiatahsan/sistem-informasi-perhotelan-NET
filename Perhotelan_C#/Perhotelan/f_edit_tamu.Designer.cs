...
{
    [DesignerGenerated()]
    public partial class f_edit_tamu : Form
    {
        ...
        {
            var resources = new System.ComponentModel.ComponentResourceManager(typeof(f_edit_tamu));
            _Panel1 = new Panel();
            _L_header = new Label();
            _Label1 = new Label();
            _T_nama = new TextBox();
            ...
            _Label1.Size = new Size(61, 22);
            _Label1.TabIndex = 2;
            _Label1.Text = "ID Tamu";
            // 
            // T_nama
            // 
            ...
            _Label2.Size = new Size(87, 22);
            _Label2.TabIndex = 4;
            _Label2.Text = "Nama Tamu";
            // 
            // Label3
            // 
            ...
            Load += new EventHandler(f_edit_tamu_Load);
            ResumeLayout(false);
            PerformLayout();
        }
